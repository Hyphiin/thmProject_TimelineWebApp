...
import {
    clickButtonAdd,
    clickButtonEdit,
    hoverCreateButton, hoverExitCreateButton
} from "./Animation";
        ...
        return (
            <form id="form" className="form">
                ...
                <div className="form_input" id="form_input">
                    <textarea className="desc" ref={e => this.description = e} id="form_desc" rows="5"
                              placeholder='Beschreibung' value={this.state.description}
                              onChange={e => this.setState({description: e.target.value})}/>
                    <input className="tag" ref={e => this.tag = e} id="form_tag" placeholder='Tag'
                           value={this.state.tag} onChange={e => this.setState({tag: e.target.value})}/>
                    <input className="date" ref={e => this.date = e} id="form_date" type="date" value={this.state.date}
                           onChange={e => this.setState({date: e.target.value})}/>
                    <p className="iInsert"><IconInsert/></p>
                    <p className="fInsert"><FileInput/></p>
                </div>
                <div id="form_button" className="formbutton">
                    <button onMouseEnter={e => hoverCreateButton(e)}
                            onMouseOut={e => hoverExitCreateButton(e)}
                            onClickCapture={e => clickButtonAdd()}
                            ref={e => this.button_add = e} className="button" id="form_button_add"
                            onClick={(e) => this.onSubmit(e, "add")}>Eintrag erstellen
                    </button>
                    <var className="divider"/>
                    <button onMouseEnter={e => hoverCreateButton(e)}
                            onMouseOut={e => hoverExitCreateButton(e)}
                            onClickCapture={e => clickButtonEdit()}
                            ref={e => this.button_edit = e} className="button" id="form_button_edit"
                            onClick={(e) => this.onSubmit(e, "edit")}>Eintrag bearbeiten
                    </button>
                    <var className="divider"/>
                    <button onMouseEnter={e => hoverCreateButton(e)}
                            onMouseOut={e => hoverExitCreateButton(e)}
                            onClickCapture={e => clickButtonEdit()}
                            ref={e => this.button_delete = e} className="button" id="form_button_delete"
                            onClick={(e) => this.onSubmit(e, "delete")}>Eintrag löschen
                    </button>
                </div>
            </form>
        )
